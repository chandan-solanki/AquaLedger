...
from app.modules.purchase_orders import models as purchase_orders_models  # noqa: F401
...
# Override the .ini URL with the app's own settings (single source of truth).
