"""Delivery challan numbering (ARCHITECTURE.md §13.1 applied to delivery
challans, mirroring app.modules.purchase_orders.domain.numbering verbatim).
...
lives in DeliveryChallanRepository/DeliveryChallanService, since that
...
def fiscal_year_for(challan_date: dt.date) -> str:
...
def format_delivery_challan_number(prefix: str, fiscal_year: str, sequence: int) -> str:
    """`{prefix}/{fiscal_year}/{zero-padded sequence}`, e.g. "DC/2026-27/00001"."""
