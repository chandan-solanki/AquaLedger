...
class TestFiscalYearFor:
    ...
    def test_indian_gst_fiscal_year_boundaries(self, challan_date: dt.date, expected: str) -> None:
        assert fiscal_year_for(challan_date) == expected

    def test_century_rollover_stays_two_digits(self) -> None:
        assert fiscal_year_for(dt.date(2099, 4, 1)) == "2099-00"


class TestFormatDeliveryChallanNumber:
    def test_pads_sequence_to_five_digits(self) -> None:
        assert format_delivery_challan_number("DC", "2026-27", 1) == "DC/2026-27/00001"

    def test_does_not_truncate_a_sequence_wider_than_the_padding(self) -> None:
        assert format_delivery_challan_number("DC", "2026-27", 123456) == "DC/2026-27/123456"

    def test_uses_the_given_prefix_verbatim(self) -> None:
        assert format_delivery_challan_number("XYZ", "2025-26", 42) == "XYZ/2025-26/00042"
