...
class TestFormatSupplierPaymentNumber:
    def test_pads_sequence_to_five_digits(self) -> None:
        assert format_supplier_payment_number("SPAY", "2026-27", 1) == "SPAY/2026-27/00001"

    def test_does_not_truncate_a_sequence_wider_than_the_padding(self) -> None:
        assert format_supplier_payment_number("SPAY", "2026-27", 123456) == "SPAY/2026-27/123456"

    def test_uses_the_given_prefix_verbatim(self) -> None:
        assert format_supplier_payment_number("XYZ", "2025-26", 42) == "XYZ/2025-26/00042"
