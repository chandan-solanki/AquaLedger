...
export async function PUT(
  ...
  try {
    ...
    const data = await authenticatedBackendRequest(`/payments/${id}/allocations/${allocationId}`, {
      method: "PUT",
      body,
    });
...
export async function DELETE(
  ...
  try {
    const { id, allocationId } = await params;
    await authenticatedBackendRequest(`/payments/${id}/allocations/${allocationId}`, {
      method: "DELETE",
    });
